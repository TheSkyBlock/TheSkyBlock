...
# @private
    ...
    #declare function asset:sacred_treasure/0210.terra_blade/3.1.terra_shot_tick
    #declare function asset:sacred_treasure/0210.terra_blade/3.2.terra_shot_init
    #declare function asset:sacred_treasure/0210.terra_blade/3.3.terra_shot_main
